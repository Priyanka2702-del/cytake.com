...
const milestones = [
  { year: "2017", title: "Founded", desc: "CYTAKE was established with a mission to democratize enterprise forex technology for brokers of all sizes." },
  { year: "2018", title: "First 10 Brokers", desc: "Deployed our first complete broker infrastructure packages, establishing our core technology stack." },
  { year: "2019", title: "Prop Firm Platform", desc: "Launched the first version of our prop trading technology, entering the rapidly growing prop firm market." },
  { year: "2021", title: "50 Countries", desc: "Expanded our global footprint to serve clients across 50+ countries on 6 continents." },
  { year: "2022", title: "AI Integration", desc: "Integrated AI automation into our CRM and risk management systems, ahead of industry adoption." },
  { year: "2024", title: "200+ Brokers", desc: "Crossed 200 active broker and prop firm clients, $5B+ in monthly volume processed." },
];
...
function TeamCard({ member }: { member: any }) {
  ...
  return (
    <div className="group flex flex-col bg-white/[0.04] backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden hover:border-sky-400/30 hover:shadow-[0_20px_40px_rgba(56,189,248,0.1)] transition-all duration-500">
      {/* Image */}
      <div className="relative h-72 overflow-hidden bg-[#050E1F]">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={member.image}
          alt={member.name}
          className="block w-full h-full object-contain object-center bg-[#050E1F] transition-transform duration-500 group-hover:scale-105"
        />
      ...
      <div className="p-7 flex flex-col flex-1">
        <h3 className="text-xl font-black text-white mb-1 group-hover:text-sky-400 transition-colors">{member.name}</h3>
        <p className="text-xs font-bold text-sky-400 uppercase tracking-widest mb-4">{member.role}</p>
        ...
        <p className="text-slate-400 text-sm leading-relaxed mb-4 flex-1">
          ...
          {isLong && (
            <button onClick={() => setExpanded(!expanded)} className="text-sky-400 font-bold ml-1 hover:text-sky-300 transition-colors focus:outline-none">
              {expanded ? "Read less" : "Read more"}
            </button>
          )}
        </p>
        <div className="flex gap-2 pt-4 border-t border-white/10">
          <a href="#" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-[#020617] via-[#0A1628] to-[#020617]">
        ...
        <div className="fixed inset-0 pointer-events-none z-0">
          <motion.div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full bg-blue-500/15 blur-[120px]"
            animate={{ x: [0, 40, 0], y: [0, 30, 0], scale: [1, 1.1, 1] }}
            transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} />
          <motion.div className="absolute bottom-[-10%] right-[-5%] w-[600px] h-[600px] rounded-full bg-indigo-500/15 blur-[130px]"
          ...
          <motion.div className="absolute inset-0 opacity-30" animate={{ x: ["-3%", "3%", "-3%"] }} transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}>
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1400 800" preserveAspectRatio="none">
              <motion.path d="M0,500 L70,470 L140,510 L210,440 L280,480 L350,400 L420,450 L490,370 L560,420 L630,340 L700,390 L770,310 L840,360 L910,290 L980,340 L1050,270 L1120,320 L1190,250 L1260,300 L1330,240 L1400,290"
          ...
          {[{ top: "25%", delay: 0, duration: 16 }, { top: "50%", delay: 5, duration: 20 }, { top: "72%", delay: 9, duration: 18 }].map((dot, i) => (
            <motion.div key={i} className="absolute w-2 h-2 rounded-full bg-sky-400 shadow-[0_0_14px_rgba(56,189,248,0.9)]"
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                  <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-6">
                    ...
                    <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">About CYTAKE Global</span>
                  </div>
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                    Building the Technology{" "}
                    <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">That Powers Forex</span>
                  </h1>
                  ...
                  <div className="flex gap-6 flex-wrap">
                    {[{ val: "200+", label: "Clients Served" }, { val: "50+", label: "Countries" }, { val: "7+", label: "Years" }].map((s, i) => (
                      <div key={i} className="bg-white/5 border border-white/10 rounded-2xl px-5 py-3">
                        <div className="text-3xl font-black bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">{s.val}</div>
                ...
                <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}>
                  <div className="relative bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                    ...
                    <h3 className="text-xl font-black text-white mb-6">Our Mission</h3>
                    <blockquote className="text-lg font-medium text-slate-300 leading-relaxed mb-8 border-l-2 border-sky-400 pl-6">
                    ...
                    <div className="flex items-center gap-3 border-t border-white/10 pt-6">
                      <div className="w-9 h-9 rounded-full bg-sky-500/20 border border-sky-400/30 flex items-center justify-center text-sky-400 font-black text-xs">CG</div>
                      <div>
                        <p className="text-sm font-bold text-white">CYTAKE Leadership</p>
                        <p className="text-xs text-slate-500">Global Operations Team</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4">
                  <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />
                  <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">Our Values</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
                  What We <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">Stand For</span>
                </h2>
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">The principles that guide how we build, deliver, and support our clients.</p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {values.map(({ icon: Icon, title, desc }, i) => (
                  <motion.div key={title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                    className="group bg-white/[0.04] border border-white/10 hover:border-sky-400/30 rounded-2xl p-7 hover:-translate-y-1 hover:bg-white/[0.06] transition-all">
                    ...
                    <h3 className="text-lg font-bold text-white mb-2 group-hover:text-sky-400 transition-colors">{title}</h3>
          ...
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4">
                  <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />
                  <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">Leadership</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
                  Meet the <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">People Behind CYTAKE</span>
                </h2>
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">A global team of forex technology experts dedicated to your success.</p>
              </motion.div>
...
<section className="py-20">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
      <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4">
        <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />
        <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">Business Development</span>
      </div>
      <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
        Our <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">Growth Team</span>
      </h2>
      <p className="text-slate-400 text-lg max-w-2xl mx-auto">Dedicated professionals driving partnerships, client success, and global expansion.</p>
    </motion.div>
      ...
      {bdTeam.slice(0, 3).map((member, i) => (
        <motion.div key={member.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
          ...
          <div className="p-5 text-center">
            <h3 className="text-white font-black text-base mb-1 group-hover:text-sky-400 transition-colors">{member.name}</h3>
            <p className="text-sky-400 text-xs font-semibold">{member.role}</p>
          ...
          <section className="py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4">
                  <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />
                  <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">Our Story</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
                  7+ Years of <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">Building Excellence</span>
                </h2>
              </motion.div>
                ...
                <div className="space-y-8">
                  {milestones.map(({ year, title, desc }, i) => (
                    <motion.div key={year} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                      className="relative flex items-start gap-8 pl-20 group">
                      <div className="absolute left-4 -translate-x-1/2 w-9 h-9 rounded-full bg-sky-500/20 border-2 border-sky-400 flex items-center justify-center text-xs font-black text-sky-400 shrink-0 mt-1 group-hover:bg-sky-500 group-hover:text-white transition-all">
                        {year.slice(2)}
                      </div>
                      <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 flex-1 hover:border-sky-400/20 transition-colors">
                        <div className="flex items-center gap-3 mb-2">
                          <span className="text-xs font-black text-sky-400 uppercase tracking-widest bg-sky-500/10 px-2 py-1 rounded-md">{year}</span>
          ...
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4">
                  <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse" />
                  <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">Global Presence</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
                  A Truly <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">Global Operation</span>
                </h2>
                <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto">
                  Our technology delivery team operates across multiple time zones, ensuring round-the-clock coverage for clients in every region.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  <motion.div key={region} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                    className="group bg-white/[0.04] border border-white/10 hover:border-sky-400/30 rounded-2xl p-5 hover:-translate-y-1 transition-all">
                    ...
                    <div className="text-sm font-bold text-white mb-1">{region}</div>
                    <div className="text-[10px] text-slate-500 font-medium">{hubs}</div>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Ready to Partner with <span className="bg-gradient-to-r from-sky-400 to-cyan-300 bg-clip-text text-transparent">CYTAKE?</span></h2>
