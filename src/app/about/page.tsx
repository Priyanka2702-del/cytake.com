...
const milestones = [
  {
    ...
    desc: "Cytake Global was founded with a vision to revolutionize the Forex and FinTech industry through innovative technology solutions",
  },
  {
    year: "2024",
    title: "Forex Ecosystem Development",
    desc: "Built a strong ecosystem of Forex CRM, Broker Management Systems, Trading Infrastructure, and Automation Solutions.",
  },
  {
    year: "2025",
    title: "Global Broker Expansion",
    desc: "Expanded globally, supporting 50+ brokers and financial businesses with White Label Solutions, MT4/MT5 Integration, Copy Trading, AI Tools, and Brokerage Technology.",
  },
  {
    year: "2026",
    title: "Worldwide Forex Solutions",
    desc: "Serving clients worldwide with trusted, scalable, and high-performance Forex solutions, helping brokers launch, grow, and succeed in competitive markets.",
  },
];
...
const values = [
  {
    ...
    desc: "We build with security at the foundation — not as an afterthought. Every system is hardened to enterprise standards.",
  },
  {
    icon: Globe,
    title: "Global Mindset",
    desc: "Our team and clients span 6 continents. We think and build for the global market from day one.",
  },
  {
    icon: Rocket,
    title: "Relentless Innovation",
    desc: "The forex and fintech industry evolves fast. We stay ahead so our clients don't have to.",
  },
  {
    icon: Users,
    title: "Client Partnership",
    desc: "We treat every client as a long-term partner, not a transaction. Your success is our success.",
  },
  {
    icon: Cpu,
    title: "Technical Excellence",
    desc: "Engineering rigor and attention to detail in every line of code and every system we deploy.",
  },
  {
    icon: Briefcase,
    title: "Industry Expertise",
    desc: "Deep, genuine domain knowledge in forex and fintech — not generalists pretending to specialize.",
  },
];
...
const team = [
  {
    ...
    role: "Founder & CEO",
    linkedin:
      "https://www.linkedin.com/in/chandrakantr62?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
    ...
    <div className="group flex flex-col border border-white/10 rounded-3xl overflow-hidden hover:border-sky-400/30 hover:shadow-[0_20px_40px_rgba(56,189,248,0.1)] transition-all duration-500 h-full">
      ...
      <div className="p-7 sm:p-8 flex flex-col flex-1">
        ...
        <p className="text-slate-400 text-sm leading-relaxed mb-4 flex-1">
          {isLong && !expanded
            ? `${member.desc.slice(0, MAX)}...`
            : member.desc}
          {isLong && (
            <button
              onClick={() => setExpanded(!expanded)}
              className="text-sky-400 font-bold ml-1 hover:text-sky-300 transition-colors focus:outline-none"
            >
        ...
        <div className="flex gap-2 pt-4 border-t border-white/10">
          <a
            ...
            className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all"
          >
...
function BDTeamCard({ member }: { member: any }) {
  return (
    <motion.div className="group relative rounded-3xl overflow-hidden bg-white/[0.04] border border-white/10 hover:border-sky-400/30 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(56,189,248,0.1)] transition-all duration-500">
      ...
      <div className="p-5 text-center">
        <h3 className="text-white font-black text-base mb-1 group-hover:text-sky-400 transition-colors">
          {member.name}
        </h3>
              ...
              {[70, 210, 350, 490, 630, 770, 910, 1050, 1190, 1330].map(
                (cx, i) => (
                  <g key={i}>
                    <line
                      x1={cx}
                      y1={[455, 425, 385, 355, 325, 295, 275, 255, 235, 205][i]}
                      x2={cx}
                      y2={[525, 495, 495, 465, 435, 405, 375, 355, 335, 305][i]}
                      stroke="#22C55E"
                      strokeWidth="1.5"
                      opacity="0.5"
                    />
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  <p className="text-slate-400 text-lg leading-relaxed mb-6">
                    CYTAKE Global is a forex and fintech infrastructure company
                    founded to give brokers and trading businesses access to the
                    same enterprise-grade technology used by the world&apos;s
                    largest financial institutions.
                  </p>
                  <p className="text-slate-500 text-base leading-relaxed mb-10">
                    We believe that every serious forex and fintech business
                    deserves access to world-class infrastructure — not just the
                    ones with massive budgets.
                  </p>
                ...
                >
                  <div className="relative bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                    ...
                    <blockquote className="text-lg font-medium text-slate-300 leading-relaxed mb-8 border-l-2 border-sky-400 pl-6">
                      &ldquo;To provide every forex and fintech business with
                      the enterprise technology they need to compete globally —
                      delivered faster, better, and more reliably than anyone
                      else.&rdquo;
                    </blockquote>
                    <div className="flex items-center gap-3 border-t border-white/10 pt-6">
                      <div className="w-9 h-9 rounded-full bg-sky-500/20 border border-sky-400/30 flex items-center justify-center text-sky-400 font-black text-xs">
                        CG
                      </div>
                      <div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
                  Meet the{" "}
                  <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">
                    People Behind CYTAKE
                  </span>
                </h2>
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">
                  A global team of forex technology experts dedicated to your
                  success.
                </p>
              </motion.div>
          ...
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">
                  Dedicated professionals driving partnerships, client success,
                    ...
                    >
                      ...
                      <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 flex-1 hover:border-sky-400/20 transition-colors">
                        <div className="flex items-center gap-3 mb-2">
                          <span className="text-xs font-black text-sky-400 uppercase tracking-widest bg-sky-500/10 px-2 py-1 rounded-md">
                            {year}
                          </span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                ...
                <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto">
                  Our technology delivery team operates across multiple time
                  zones, ensuring round-the-clock coverage for clients in every
                  region.
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-300 text-lg mb-10 max-w-2xl mx-auto">
                    Join 200+ brokers and prop firms powered by our enterprise
                    infrastructure.
                  </p>
