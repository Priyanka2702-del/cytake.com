...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-gradient-to-br from-[#020617] via-[#0A1628] to-[#020617]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-full mb-4">
            ...
            <span className="text-xs font-bold text-sky-400 tracking-wide uppercase">Get in Touch</span>
          </div>
          ...
          >
            {[
              ...
              <motion.a
                ...
                href={href}
                whileHover={{ y: -4 }}
                className="rounded-2xl p-5 flex items-center gap-4 group block bg-white/[0.04] backdrop-blur-sm border border-white/10 shadow-md hover:shadow-xl hover:border-sky-400/30 transition-all"
              >
            ...
            <div className="rounded-2xl p-6 bg-white/[0.04] backdrop-blur-sm border border-white/10">
              <h4 className="text-sm font-black text-white mb-3">What to Expect</h4>
            ...
            <div className="rounded-3xl p-8 bg-white/[0.04] backdrop-blur-xl border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
              {sent ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-400">Our team will get back to you within 2 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        name="name" value={form.name} onChange={handleChange} required placeholder="John Mitchell"
                    ...
                    <div>
                      ...
                      <input
                        name="email" type="email" value={form.email} onChange={handleChange} required placeholder="john@company.com"
                        className="w-full px-4 py-3 rounded-xl text-sm bg-white/5 border border-white/10 text-white placeholder:text-slate-600 focus:border-sky-400/50 focus:ring-2 focus:ring-sky-400/10 outline-none transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        name="company" value={form.company} onChange={handleChange} placeholder="Your Company Ltd"
                        className="w-full px-4 py-3 rounded-xl text-sm bg-white/5 border border-white/10 text-white placeholder:text-slate-600 focus:border-sky-400/50 focus:ring-2 focus:ring-sky-400/10 outline-none transition-all"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        name="phone" value={form.phone} onChange={handleChange} placeholder="+1 234 567 890"
                        className="w-full px-4 py-3 rounded-xl text-sm bg-white/5 border border-white/10 text-white placeholder:text-slate-600 focus:border-sky-400/50 focus:ring-2 focus:ring-sky-400/10 outline-none transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-1.5">Solution of Interest</label>
                    <select
                      name="solution" value={form.solution} onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl text-sm bg-white/5 border border-white/10 text-white focus:border-sky-400/50 focus:ring-2 focus:ring-sky-400/10 outline-none transition-all"
                    >
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 text-black font-bold rounded-xl px-6 py-3.5 bg-white hover:bg-gray-100 disabled:opacity-60 transition-all shadow-[0_0_20px_rgba(255,255,255,0.15)]"
                  >
                    {loading ? (
                      <>
